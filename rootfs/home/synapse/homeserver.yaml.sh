...
# on port 443.)
#
public_baseurl: https://${DOMAIN_MATRIX}/
...
# not \`cert.pem\`).
#
#tls_certificate_path: "/data/matrix.crockett.network.tls.crt"

# PEM-encoded private key for TLS
#
#tls_private_key_path: "/data/matrix.crockett.network.tls.key"
...
#
log_config: "/data/matrix.crockett.network.log.config"
...
#
registration_shared_secret: "Iyqe.@hg@&wqm*I&DZL1K@w0dS&4YO^oLM00ae^panuwPKtHLb"
...
#
macaroon_secret_key: "e4sqnuYw=xxBsi@VA8TB~.p9dM4QyNuE*fWpmaNOZ0^QKg_^.i"

# a secret which is used to calculate HMACs for form values, to stop
# falsification of values. Must be specified for the User Consent
# forms to work.
#
form_secret: "ynJ1uIbRSd;#Ym9qkVm_Wa:JiIr-6~6:@jE0_Q:&yQdoE-3R&f"

## Signing Keys ##

# Path to the signing key to sign messages with
#
signing_key_path: "/data/matrix.crockett.network.signing.key"

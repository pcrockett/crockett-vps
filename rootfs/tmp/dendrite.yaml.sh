...
# This is the Dendrite configuration file. It was copy / paste / modified from:
#
...
# This file was auto-generated using the de.crockett.network repository. Don't
# edit it directly. For more info see:
#
#     https://github.com/pcrockett/de.crockett.network/
#
